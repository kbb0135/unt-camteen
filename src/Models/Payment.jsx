            ...
            <ul className="items-ul">
              {cartItems.map((item) => (
                <li key={item.id} index={item.name} className="cart-item">
                  <img src={item.image} className="img-cart"></img>-{item.name}{" "}
                  - ${item.price}{" "}
              ...
              {user ? (
                <>
                  <div className="my-btn">
                    <p className="total-pay">
                      Discount Code Applied: {couponName}
                    </p>
                    <p className="total-pay">Discount Amount: ${price}</p>
                    <hr></hr>
                    <p className="total-pay-dicount">
                      {" "}
                      New Total: {discountTotal.toFixed(2)}
                    </p>
                  </div>
                </>
              ) : (
                <>
                  <div className="my-btn">
                    ...
                    <p className="total-pay">
                      Discount Amount: $ {localStorage.getItem("discountCode")}
                    </p>
                    <hr></hr>
                    <p className="total-pay-discount">
                      {" "}
                      New Total: {discountTotal.toFixed(2)}
                    </p>
                  </div>
